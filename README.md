...
## Installation
  ...
  * Finally, launch the installer: http://your-domain/akaunting-directory/index.php/install/language
  * More details for the [installer](https://akaunting.com/docs/installation)
